...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import tree_sitter_rust_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("b2197e8e-fe20-5781-846b-d7979e3cddf2"))
platforms = [Pkg.Artifacts.unpack_platform(e, "tree_sitter_rust", artifacts_toml) for e in artifacts["tree_sitter_rust"]]
...
if best_platform === nothing
    @debug("Unable to load tree_sitter_rust; unsupported platform $(triplet(platform_key_abi()))")
else
...
end  # module tree_sitter_rust_jll
